    ...
    def create_bilingual_lesson_prompt(
        ...
        level_settings = {
            'beginner': {
                ...
                'transcription': 'Обязательно давай транскрипцию [в квадратных скобках]'
            },
            'intermediate': {
                ...
                'transcription': 'Давай транскрипцию только для сложных слов'
            },
            'advanced': {
                ...
                'transcription': 'Транскрипция только при первом упоминании слова'
            }
        }
