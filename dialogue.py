...
ВАЖНО: Разделяй текст пустыми строками после каждых 4-5 предложений!"""
    ...
    def process_input(self, text: str) -> Optional[str]:
        ...
        # Сбрасываем состояние урока если он завершен и пользователь запрашивает новый
        if self.lesson_started and any(word in text_lower for word in ["новый урок", "другой урок", "давай изучим", "расскажи про"]):
            self.lesson_started = False
