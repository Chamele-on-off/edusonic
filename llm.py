...
2. Определи 3-4 расширяющих текст словосочетания для слайда будущей презентации по данному тексту
3. Верни ответ ТОЛЬКО в формате JSON

Формат JSON:
{{
    "main_concept": "основное понятие",
    "aspects": ["словосочетание 1", "словосочетание 2", "словосочетание 3"]
}}

Пример для "Фотосинтез":
{{
    "main_concept": "Экономика",
    "aspects": ["Изучается хозяйство", "Решает вопросы распределения благ", "Решает вопросы производства благ", "Изучает экономическую политику"]
}}
